...
function files(instance, options) {
    return through.obj(function (file, enc, callback) {
        if (options) {
            if (options.mode || options.user || options.group) {
                file.attr = [
                    options.mode || null,
                    options.user || null,
                    options.group || null,
            ...
            file.config = !! options.config;
            file.noreplace = !! options.noreplace;
        }
...
function build(instance) {
    return through.obj(function (file, enc, callback) {
        ...
        proc = spawn(command.shift(), command, { cwd: instance.buildDir_SPECS, stdio: 'ignore' });
